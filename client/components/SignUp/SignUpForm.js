  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit(this.submitForm)}>
        ...
        <div className="row">
          <div className="input-field col s12">
            <Field name="lastName" type="text" icon="account_circle" component={InputText} label="Last Name" />
          </div>
        </div>
        ...
        <div className="row">
          <div className="input-field col s12">
            <Field name="password2" type="password" label="Confirm Password" icon="lock" component={InputText} />
          </div>
        </div><br />
        ...
        <div className="row">
          <div className="col s12 center-align">
            <button className="btn waves-effect primary-button waves-light" type="submit" disabled={isSigningUp} name="action">Submit
            { isSigningUp ?
