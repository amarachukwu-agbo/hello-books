...
describe('Books Controller', () => {
  ...
  describe('PUT /api/v1/books/:bookId', () => {
    ...
    it('should throw 409 error if admin tries to update book title with a title that exists in the database', (done) => {
      request(app)
        .put('/api/v1/books/1')
        .set('Authorization', `Token ${adminToken}`)
        .send({ title: 'Americanah' })
  ...
  describe('POST /api/v1/books/search', () => {
    ...
    it('should return 204 status if no book matches the query', (done) => {
      request(app)
